...
function SetData()
	...
	Citizen.InvokeNative(GetHashKey("ADD_TEXT_ENTRY"), 'FE_THDR_GTAO', '~r~Ynov Life~s~ | ID : ~p~'.. id ..'~w~ | Joueurs connectés : ~p~' .. #players .."~w~/64 " )
end
...
Citizen.CreateThread(function()
    AddTextEntry("PM_PANE_LEAVE", "~r~Se déconnecter ~w~de~r~ Ynov Life")
end)
...
print("^4WayZe#0001 ^7| ^1Utils Core démarré !")