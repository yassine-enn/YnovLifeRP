Locales['fr'] = {
  ...
  ['no_vehicle_nearby']         = 'aucune voiture à proximité',
  ['inside_vehicle']            = 'vous ne pouvez pas faire ça à l\'intérieur du véhicule!', 
  ...
  ['player_cannot_hold']        = 'vous n\' ~r~avez~s~ pas assez ~y~de place~s~ dans votre inventaire!',
}
